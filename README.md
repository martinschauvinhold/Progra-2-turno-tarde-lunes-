...
acolar(int x)
Funcionamiento: Recibe un número entero x (el ID) y lo ubica al final de la fila de espera. Utiliza lógica de Aritmética para determinar la posición en el arreglo, asegurando que si hay espacio disponible al principio del mismo, el ID sea guardado allí.
...
Contexto de uso: El usuario lo utiliza para saber qué ID fue el ultimo en crearse
